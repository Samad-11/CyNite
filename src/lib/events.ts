...
export const events = [
    {
        ...
        rules: [
            ...
            "* Registration opens. On the spot event registration till fixed time.",
            ...
            '* Any misbehaviour or any kind of property damage will lead to direct disqualification.',
        ],
    ...
    },
    {
        ...
        rules: [
            ...
            "* A specific website design prompt will be revealed at the start of the competition. This prompt will include details about the website's functionalities or features.",
            "* By the end of (25) minutes, participants must submit a high-fidelity mock-up of the website's homepage in Figma, including:",
        ],
    ...
    },
    {
        ...
        description: [
            ...
            "Dive into the heart-pounding action of gaming-related events and tournaments that will leave you on the edge of your seat, craving for more!",
            "Are you a sharpshooter? A master tactician? Or perhaps a button-mashing champion? Whatever your gaming style, we've got you covered with an array of thrilling competitions featuring popular titles like Valorant, BGMI (BattleGrounds Mobile India), Tekken 7, and the hilarious chaos of Stumble Guys!",
            "Whether you're a seasoned gamer or just starting your journey, there's something for everyone at ArcadeArena. So, gather your squad, fuel your passion, and let the games begin! Don't miss out on the excitement – mark your calendars and be a part of the gaming revolution at ArcadeArena, where the thrill never ends!"],
    ...
    },
    {
        ...
        rules: [
                "* Participation is allowed for a team consists of 2 members.",
                '* Rules for each round will be shared before the round starts.',
    ...
    },
    {
        ...
        rules: [
                ...
                "* The presentation should comprise 8–10 slides atleast",
                "* Participants can present any innovative or business idea for technical solutions",
                "* Judgement will be based on Innovation, Methodology, Market Potential, Feasibility, and Presentation.",
            ],
    ...
    },
    {
        ...
        rules: [
                ...
                "* Rules for each round will be given on spot",
                ...
                "* In Round 1 and 2, Programming language will be provided on the spot.",
    ...
    },
    {
        ...
        rules: [
                ...
                "* Each round allow individual participation only.",
                "* Rules for each round will be given on spot",
                "* Participants need to introduce themselves with their name, college, and department.",
                "* No use of AI tools during the event.",
         ...
         studentCoordinators:"PRASANNA PAWAN(IT CLUB), TUSHAR ARORA (IT CLUB), LAKSHAY (IT CLUB), MEHAK ARORA, GURNOOR, SURAJ KUSHWAHA",
